...
(
    ...
    # Setup the directory where our MaryJaneCoin build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built MaryJaneCoin to $INSTALLPATH
    case "$HOST" in
        *darwin*)
    ...
    (
        ...
        # copy over the example maryjanecoin.conf file. if contrib/devtools/gen-maryjanecoin-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/MaryJaneCoin.conf" "${DISTNAME}/"
