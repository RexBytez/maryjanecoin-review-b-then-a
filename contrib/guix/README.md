# Bootstrappable MaryJaneCoin Builds

This directory contains the files necessary to perform bootstrappable MaryJaneCoin
builds.
...
To build MaryJaneCoin reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      MaryJaneCoin version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/maryjanecoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://gitlab.com/MaryJaneCoin/guix.sigs).
...
* _**SDK_PATH**_
  ...
  `$HOME/Downloads/macOS-SDKs/Xcode-15.0-15A240d-extracted-SDK-with-libcxx-headers`).
