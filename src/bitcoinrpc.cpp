...
{
    return GetBoolArg("-testnet", false) ? 25201 : 14201;
}
...
static const CRPCCommand vRPCCommands[] =
{
    ...
    { "createbootstrap",        &createbootstrap,        true,   true },
    { "reorganizetoheight",     &reorganizetoheight,     true,   true },
...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
    ...
    if (strMethod == "reorganizetoheight"     && n > 0) ConvertTo<boost::int64_t>(params[0]);
