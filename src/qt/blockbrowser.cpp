...
#include <qt/forms/ui_blockbrowser.h>
#include "main.h"
#include "wallet.h"
#include "base58.h"
...
void BlockBrowser::setTx(QString txid)
{
	ui->txBox->setText(txid);
	txClicked();
}
...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " MARYJ");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " MARYJ");
    }
}
