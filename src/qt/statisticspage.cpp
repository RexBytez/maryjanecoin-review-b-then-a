...
#include <qt/forms/ui_statisticspage.h>
#include "main.h"
#include "wallet.h"
#include "init.h"
#include "base58.h"
...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " MARYJ" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " MARYJ" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " MARYJ");
    }
