    ...
    model(0)
{
	...
	ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a MaryJaneCoin address (e.g. MBDKLakRxSRw7hUB2q5DXEnDpNpLVkqGZd)"));
...
void SendCoinsDialog::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance, qint64 conflictedBalance, qint64 immatureBalance)
{
    Q_UNUSED(stake);
    Q_UNUSED(unconfirmedBalance);
    Q_UNUSED(conflictedBalance);
